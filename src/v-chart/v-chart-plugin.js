        ...
        Vue.component('v-chart', {
            ...
            methods: {
                ...
                generateAxisLabels(cs) {
                    let footer = this.chartData.legends ? 0.85 : 0.95;
            ...
            computed: {
                ...
                ds() {
                    ...
                    return ds.data.map((d) => {
                        ...
                        td.dim = this.chartData.dim
                            ? d[this.chartData.dim]
                            : null;
                        return td;
                    });
                },
                 ...
                 */
                metric() {
                    const metric = Array.isArray(this.chartData.metric)
                ...
                gridTicks() {
                    if (
                        this.chartData.grid &&
                        this.chartData.grid.gridTicks != null
                    ) {
